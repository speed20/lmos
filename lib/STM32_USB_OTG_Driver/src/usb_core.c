...
USB_OTG_STS USB_OTG_CoreInitDev (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  for (i = 0; i <  pdev->cfg.dev_endpoints; i++)
  {
    USB_OTG_DEPCTL_TypeDef  depctl_inner;
    depctl_inner.d32 = USB_OTG_READ_REG32(&pdev->regs.OUTEP_REGS[i]->DOEPCTL);
    if (depctl_inner.b.epena)
    {
      depctl_inner.d32 = 0;
      depctl_inner.b.epdis = 1;
      depctl_inner.b.snak = 1;
    }
    else
    {
      depctl_inner.d32 = 0;
    }
    USB_OTG_WRITE_REG32( &pdev->regs.OUTEP_REGS[i]->DOEPCTL, depctl_inner.d32);
