...
//#define DEBUG_MPU
#ifdef DEBUG_MPU
#define log_i serial_println
#define log_e serial_println
#define log_d serial_println
#else
...
#elif defined HMC5883L_SECONDARY
	serial_println("enter setup compass");
