...
#elif !defined AK8975_SECONDARY || !defined HMC5883L_SECONDARY/* #if defined AK8963_SECONDARY */
//#define AK8975_SECONDARY
...
#else
#ifdef HMC5883L_SECONDARY
    if (i2c_read(st.hw->addr, st.reg->raw_compass, 6, &tmp[0]))
        return -1;
#else
