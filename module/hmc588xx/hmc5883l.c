...
bool hmc5883l_testConnection() {
	uint8_t buffer[3];
    if (i2c_read_bytes(&hmc5883l, HMC5883L_RA_ID_A, 3, buffer) == 3) {
...
uint8_t hmc5883l_getSampleAveraging() {
    return i2c_read_bits(&hmc5883l, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_AVERAGE_BIT, HMC5883L_CRA_AVERAGE_LENGTH);
}
...
void hmc5883l_setSampleAveraging(uint8_t averaging) {
    i2c_write_bits(&hmc5883l, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_AVERAGE_BIT, HMC5883L_CRA_AVERAGE_LENGTH, averaging);
}
...
uint8_t hmc5883l_getDataRate() {
    return i2c_read_bits(&hmc5883l, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_RATE_BIT, HMC5883L_CRA_RATE_LENGTH);
}
...
void hmc5883l_setDataRate(uint8_t rate) {
    i2c_write_bits(&hmc5883l, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_RATE_BIT, HMC5883L_CRA_RATE_LENGTH, rate);
}
...
uint8_t hmc5883l_getMeasurementBias() {
    return i2c_read_bits(&hmc5883l, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_BIAS_BIT, HMC5883L_CRA_BIAS_LENGTH);
}
...
void hmc5883l_setMeasurementBias(uint8_t bias) {
    i2c_write_bits(&hmc5883l, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_BIAS_BIT, HMC5883L_CRA_BIAS_LENGTH, bias);
}
...
uint8_t hmc5883l_getGain() {
    return i2c_read_bits(&hmc5883l, HMC5883L_RA_CONFIG_B, HMC5883L_CRB_GAIN_BIT, HMC5883L_CRB_GAIN_LENGTH);
}
...
void hmc5883l_setGain(uint8_t gain) {
    ...
    i2c_write_byte(&hmc5883l, HMC5883L_RA_CONFIG_B, gain << (HMC5883L_CRB_GAIN_BIT - HMC5883L_CRB_GAIN_LENGTH + 1));
}
...
uint8_t hmc5883l_getMode() {
    return i2c_read_bits(&hmc5883l, HMC5883L_RA_MODE, HMC5883L_MODEREG_BIT, HMC5883L_MODEREG_LENGTH);
}
...
void hmc5883l_setMode(uint8_t newMode) {
    ...
    // requirement specified in the datasheet; it's actually more efficient than
    // using the I2Cdev.writeBits method
    i2c_write_byte(&hmc5883l, HMC5883L_RA_MODE, mode << (HMC5883L_MODEREG_BIT - HMC5883L_MODEREG_LENGTH + 1));
...
bool hmc5883l_getLockStatus() {
    return i2c_read_bit(&hmc5883l, HMC5883L_RA_STATUS, HMC5883L_STATUS_LOCK_BIT);
}
...
bool hmc5883l_getReadyStatus() {
    return i2c_read_bit(&hmc5883l, HMC5883L_RA_STATUS, HMC5883L_STATUS_READY_BIT);
}
